export default {
  ...
  reservation: {
    ...
    successText:
      "Your reservation has been successfully registered. You will receive a confirmation email.",
  ...
  forgotPassword: {
    ...
    backToLoginMessage:
      "Do you want to abandon password reset and return to the login page?",
    missingInfo:
      "Missing email or verification code. Please go back and try again.",
  ...
  support: {
    title: "Need Help?",
    subtitle: "Send us a message and we’ll get back to you shortly.",

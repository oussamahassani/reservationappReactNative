export default {
  ...
  start: {
    ...
    exploreDesc:
      "Découvrez les sites historiques et les trésors cachés de la région de Jendouba en Tunisie.",
    experience: "Vivre l'Expérience",
    experienceDesc:
      "Plongez dans la culture locale et profitez d'expériences authentiques pendant votre séjour.",
    connect: "Se Connecter",
    connectDesc:
      "Rejoignez une communauté de voyageurs partageant les mêmes intérêts et d'habitants locaux.",
  },
  ...
  forgotPassword: {
    ...
    verificationSubtitle:
      "Entrez le code de vérification que nous avons envoyé à votre e-mail",
    ...
    backToLoginMessage:
      "Voulez-vous abandonner la réinitialisation du mot de passe et retourner à la page de connexion ?",
    missingInfo:
      "Adresse e-mail ou code de vérification manquant. Veuillez revenir en arrière et réessayer.",
    ...
    missingEmail:
      "Adresse e-mail manquante. Veuillez revenir en arrière et réessayer.",
  ...
  map: {
    ...
    permissionsMessage:
      "Nous avons besoin d'accéder à votre position pour afficher les lieux à proximité",
  ...
  support: {
    ...
    messagePlaceholder: "Décrivez votre problème ici...",
    cancel: "Annuler",
    send: "Envoyer",
  },
};

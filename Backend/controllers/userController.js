  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        <h3>📬 Nouveau message d'aide</h3>
        <p><strong>Sujet :</strong> ${subject}</p>
        <hr />
        <p>${content.replace(/\n/g, "<br>")}</p>
        <hr />
        <p style="font-size: 12px; color: gray;">Vous pouvez répondre à l'expéditeur à : <a href="mailto:${senderEmail}">${senderEmail}</a></p>
      </div>
    `,
    replyTo: senderEmail, // 📩 makes your reply go directly to the sender
  };
